// Íconos con los mismos trazos de Lucide (la librería que usa la tienda),
// en línea para no cargar nada extra.
const PATHS = {
  ...
  play: '<path d="M6 4.5v15a1 1 0 0 0 1.52.85l12-7.5a1 1 0 0 0 0-1.7l-12-7.5A1 1 0 0 0 6 4.5Z" fill="currentColor" stroke="none"/>',
  ...
  box: '<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><path d="m3.3 7 7.7 4.73a2 2 0 0 0 2 0L20.7 7"/><path d="m7.5 4.27 9 5.15"/>',
...
// Cambia cada <i data-icon="nombre"> por su SVG.
...
// El logo de la tienda: la etiqueta blanca sobre el cuadro azul.
export const LOGO_MARK = `<svg class="mark" viewBox="0 0 48 48" aria-hidden="true" focusable="false">
  <rect width="48" height="48" rx="12" fill="#003049"/>
  <g transform="translate(40.5 7.5) scale(-1.4 1.4)">
    <path fill="#fff" d="M12.59 2.59A2 2 0 0 0 11.17 2H4a2 2 0 0 0-2 2v7.17a2 2 0 0 0 .59 1.42l8.7 8.7a2.43 2.43 0 0 0 3.42 0l6.58-6.58a2.43 2.43 0 0 0 0-3.42z"/>
    <circle cx="7" cy="7" r="1.6" fill="#003049"/>
  </g>
</svg>`;
